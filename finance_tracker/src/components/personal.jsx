...
function Display_Personal({Title, Amount,onDelete,Month,day,currencySymbol}) {
    return(
...
export default function PersonalExpenses({Personal_Expenses, setExpenseArr,currencySymbol}) {

    return(
     <div className="Expense-Card-Container">
        {Personal_Expenses.map(value => (
             <Display_Personal Title={value.Expense_Title} Amount={value.Expense_Amount}
