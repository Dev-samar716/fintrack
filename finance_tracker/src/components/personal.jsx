...
function Display_Personal({Title, Amount,onDelete,Month,day,userCurrency}) {
    return(
...
export default function PersonalExpenses({Personal_Expenses, setExpenseArr,userCurrency}) {
