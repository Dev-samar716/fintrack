...
function Display_Transportation({Title, Amount,onDelete,Month,day,currencySymbol}) {
    return(
...
export default function TransportationExpenses({Transportation_Expenses, setExpenseArr,currencySymbol}) {
