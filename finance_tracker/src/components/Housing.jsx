...
function Display_Housing({Title, Amount,onDelete,Month,day,currencySymbol}) {
    return(
...
export default function HousingExpenses({Housing_Expenses, setExpenseArr,currencySymbol}) {
