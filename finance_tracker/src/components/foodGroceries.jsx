...
function Display_FoodGroceries({Title, Amount, onDelete,Month,day,userCurrency}) {
    return(
...
export default function FoodGroceriesExpenses({Food_Groceries, setExpenseArr,userCurrency}) {
