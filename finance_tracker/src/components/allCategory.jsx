...
function Display_All({Title, Amount, onDelete,Category,Month,day,currencySymbol, id, setEditId, setEdit}) {
    return(
     ...
     <div className="Expense-Card-Container">
       {edit && <EditExpense_Entries editId={editId} setEdit={setEdit} setExpenseArr={setExpenseArr}
        ...
        {thisMonthExpense.map(value => (
             ...
             onDelete={()=>Handle_Delete(value.id, setExpenseArr)} Category={value.Expense_Category}
